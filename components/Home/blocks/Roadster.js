...
const Roadster = () => {
    ...
    const handleClick = e => {
        ...
        tl.fromTo(title.current, {opacity: 1, x: 0}, {opacity: 0, x: 500, duration: 1.5}, 0.5)
        tl.fromTo(findOut.current, {opacity: 1, y: 0}, {opacity: 0, y: -150, duration: 1.5}, 0.65)
        tl.fromTo(roadsterModal.current, {opacity: 0}, {opacity: 1, duration: 1}, 0.75)
    }
    ...
    const handleClose = () => {
        ...
        tl.fromTo(roadsterImg.current, {x: bannerWidth}, {x: 0, duration: 1.5}, 0.5)
        tl.fromTo(title.current, {opacity: 0, x: 500}, {opacity: 1, x: 0, duration: 1.5}, 0.5)
        tl.fromTo(details.current, {opacity: 0, x: -500}, {opacity: 1, x: 0, duration: 1.5}, 0.65)
    }
